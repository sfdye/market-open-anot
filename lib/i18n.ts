...
const en = {
  ...
  // Named for what a reader sees, not for OneMap's `Default`/`Grey`/`Night` tile paths.
  mapStyle: 'Map style',
  mapStyleAuto: 'Automatic',
  mapStyleStandard: 'Standard',
  mapStyleGrey: 'Grey',
  mapStyleDark: 'Dark',
  mapStyleFooter: 'Automatic follows your light or dark appearance.',
  reminders: 'Reminders',
...
const zh: Record<keyof typeof en, string> = {
  ...
  mapStyleGrey: '灰色',
  mapStyleDark: '深色',
  mapStyleFooter: '“自动”会跟随您设备的浅色或深色外观。',
  reminders: '提醒',
